#give the file name at the end during execution(argv[1] means agriment on compile time
#python autodeleting.py Demo
from sys import *
import os
import hashlib
import smtplib
...
def Displayfiles(files):    #check duplicate files and send to deleting(yes or no)
